    ...
    <header className="bg-[#ff5200] font-serif">
      <div className=" flex justify-between container mx-auto py-8">
        ...
        <div className="  text-white text-base font-bold flex gap-15 items-center">
          ...
          <a className=" border border-black bg-black  rounded-2xl py-3 px-4 " target="_blank">Sign in</a>
        </div>
      </div>
      <div className="pt-16 pb-8 relative" >
        ...
        <div className="max-w-[70%] container mx-auto flex gap-5 mt-10">
          <input className="bg-white flex-1 min-w-0 text-xl px-6 py-4 rounded-2xl " placeholder="Delhi, India"></input>
          <input className="bg-white  flex-1 min-w-0 text-xl px-6 py-4 rounded-2xl" placeholder="Search for restaurant and items for more"></input>
